// app/aura-result.web.tsx — web stub. The native version renders a Skia
// aura visualization (PhotoAura.tsx → @shopify/react-native-skia), which
// can't bundle on web. Web visitors get a directive to view in the app.
...
export default function AuraResultWeb() {
  const router = useRouter()
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>View your aura in the app</Text>
        <Text style={styles.body}>
          The aura visualization — chakra spectrum, color layers, and the
          surrounding energy field — is rendered with a native graphics engine.
          Open AURA on iOS or Android to view this reading.
        </Text>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: Colors.surface, borderRadius: BorderRadius.lg, padding: Spacing.xl, maxWidth: 560, width: '100%', borderWidth: 1, borderColor: Colors.border, gap: Spacing.lg },

// app/history.web.tsx — web stub. The native history list renders Skia-backed
// aura thumbnails via PhotoAura; web visitors get a directive.
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>Your aura history is in the app</Text>
        <Text style={styles.body}>
          Past readings — chakra patterns and color layers — are rendered with a
          native graphics engine. Open AURA on iOS or Android to browse your history.
        </Text>
